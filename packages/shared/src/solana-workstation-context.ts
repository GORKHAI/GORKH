...
export const SolanaWorkstationContextReferenceKind = {
  ...
  ZERION_POLICY: 'zerion_policy',
  ZERION_PROPOSAL: 'zerion_proposal',
  ZERION_EXECUTION_RESULT: 'zerion_execution_result',
  ZERION_AUDIT_SUMMARY: 'zerion_audit_summary',
...
export const SolanaWorkstationContextSourceSchema = z.enum([
  ...
  SolanaWorkstationContextSource.ZERION_AGENT,
...
export const SolanaWorkstationContextReferenceKindSchema = z.enum([
  ...
  SolanaWorkstationContextReferenceKind.ZERION_POLICY,
  SolanaWorkstationContextReferenceKind.ZERION_PROPOSAL,
  SolanaWorkstationContextReferenceKind.ZERION_EXECUTION_RESULT,
  SolanaWorkstationContextReferenceKind.ZERION_AUDIT_SUMMARY,
