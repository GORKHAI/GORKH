...
const configSchema = z.object({
  ...
  DEFI_FEATURES_ENABLED: z.enum(['true', 'false']).default('true').transform((value) => value === 'true'),
  DEFI_CACHE_TTL_MS: z.string().transform((s) => parseInt(s, 10)).default('30000'),
  DEFI_REQUEST_TIMEOUT_MS: z.string().transform((s) => parseInt(s, 10)).default('8000'),
  SOLANA_RPC_MAINNET_URL: z.string().default(''),
  SOLANA_RPC_DEVNET_URL: z.string().default(''),
  HELIUS_API_KEY: z.string().default(''),
  SHYFT_API_KEY: z.string().default(''),
  BIRDEYE_API_KEY: z.string().default(''),
  JUPITER_API_BASE: z.string().default('https://quote-api.jup.ag'),
  KAMINO_API_BASE: z.string().default(''),
  MARGINFI_API_BASE: z.string().default(''),
  ORCA_API_BASE: z.string().default(''),
  RAYDIUM_API_BASE: z.string().default(''),
  METEORA_API_BASE: z.string().default(''),
...
function loadConfig() {
  const raw = {
    ...
    DEFI_FEATURES_ENABLED: process.env.DEFI_FEATURES_ENABLED,
    DEFI_CACHE_TTL_MS: process.env.DEFI_CACHE_TTL_MS,
    DEFI_REQUEST_TIMEOUT_MS: process.env.DEFI_REQUEST_TIMEOUT_MS,
    SOLANA_RPC_MAINNET_URL: process.env.SOLANA_RPC_MAINNET_URL,
    SOLANA_RPC_DEVNET_URL: process.env.SOLANA_RPC_DEVNET_URL,
    HELIUS_API_KEY: process.env.HELIUS_API_KEY,
    SHYFT_API_KEY: process.env.SHYFT_API_KEY,
    BIRDEYE_API_KEY: process.env.BIRDEYE_API_KEY,
    JUPITER_API_BASE: process.env.JUPITER_API_BASE,
    KAMINO_API_BASE: process.env.KAMINO_API_BASE,
    MARGINFI_API_BASE: process.env.MARGINFI_API_BASE,
    ORCA_API_BASE: process.env.ORCA_API_BASE,
    RAYDIUM_API_BASE: process.env.RAYDIUM_API_BASE,
    METEORA_API_BASE: process.env.METEORA_API_BASE,
